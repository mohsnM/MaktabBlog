...
class PostTest(TestCase):
    def setUp(self) -> None:
        ...
        post1 = Post.objects.create(
            title='post1', slug='post1', content='Weather is good', author=user, publish_time=localtime()
        )
        post1.create_setting()
        post2 = Post.objects.create(
            title='post2', slug='post2', content='I love music', author=user, publish_time=localtime()
        )
        post2.create_setting(comment=False, author=False)
        post3 = Post.objects.create(
            title='post3', slug='post3', content='Today will be better', author=user, publish_time=localtime()
        )
